...
It was the worst of times.
    ...
    assert_equal 3, long_string.lines.count  # final empty line not counted
  end
...
It was the worst of times.
EOS
    assert_equal 53, long_string.length  # first newline not counted
    assert_equal 2, long_string.lines.count  #final empty line not counted
  end
